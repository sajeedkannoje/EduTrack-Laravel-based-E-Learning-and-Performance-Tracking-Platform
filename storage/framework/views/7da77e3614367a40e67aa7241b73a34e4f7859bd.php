...
<?php $__env->startSection('content'); ?>
    <div class="main-content">
      <div class="referral-code-container card">
          ...
          <input class="referral-code-copy hiddenput form-control text-black fw-bold text-center font-medium-4" value="<?php echo e(Auth::user()->referral_code); ?>" onclick="copyText(this);"  readonly id="copyMaker"/>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-image text-center">
                            <img src="<?php echo e(asset('images/teachers/homepage/homePicture1.jpg')); ?>" alt="Welcome Image" class="rounded ml-4" width="100%">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <ul class="list-unstyled text-black font-medium-1 fw-bold">
                            ...
                            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="mt-25 teacher-module-list">
                                        <p>Module <?php echo e(($loop->index+2)); ?>:</p>
                                        <span class="mx-50 teacher-homelink-span">
                                            <a href="<?php echo e(route('teacher-single-module',$module->id)); ?>" class="text-info">
                                                <?php echo e(Str::ucfirst($module->title)); ?>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/zeroguess.us/public_html/n17/FFN/app/resources/views/content/teachers/homepage/home.blade.php ENDPATH**/ ?>