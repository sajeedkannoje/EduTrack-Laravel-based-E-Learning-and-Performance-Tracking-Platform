<?php $__env->startSection('title', 'My Certificate'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card">
                ...
                <div class="col-md-3 text-center p-2 completion-image-container">
                    <img src="<?php echo e(asset('images/certificates/certificateSuccess.jpg')); ?>" class="card-image rounded m-auto" alt="Power" height="100%">
                </div>
                <div class="card-body cer-body">
                        ...
                        <div class="row m-4 my-1 courses-flex-container">
                            <div class="courses-completion-content">
                              <div class="col-md-12 couses-badge-section">
                                <i class="fi fi-br-badge gold-medal" style="color: gold"></i>   <?php echo e(__("85-100%      Gold Medal")); ?>

                              </div>

                              <div class="col-md-12 couses-badge-section">
                                <i class="fi fi-br-badge silver-medal" style="color: silver"></i>  <?php echo e(__("70-84%       Silver Medal ")); ?>

                              </div>

                              <div class="col-md-12 couses-badge-section">
                                <i class="fi fi-br-badge bronze-medal" style="color: brown"></i> <?php echo e(__("0-69%	    Bronze Medal")); ?>
                    ...
                    <a class="text-info btn btn-primary" href="<?php echo e(route('this-section', $section->id)); ?>"> Start Where You Left</a>
            ...
            <div class="card card-completion">
                <div class="row">
                <div class="col-md-3 text-center p-2 completion-image-container">
                    <img src="<?php echo e(asset('images/certificato.png')); ?>" class="card-image rounded m-auto" alt="Power" height="100%">
                </div>
                  ...
                  <div class="module-exam-score-container">
                      <div class="module-exam-score">
                          <div class="col-sm-3 col-md-2 module-exam-score-content">
                              ...
                              <div class="conainer">
                                  <div class="circle_percent" data-percent="<?php echo e(Helper::roundScorePercentage($finalScore['userScore'],$finalScore['totalScore'])); ?>">
                  ...
                  <!-- score -->
                    <div class="card-body-info-text">
                      <div class="text-black font-medium-2 fw-bold certificate-card-body">
                          Your Score : <span class="certificate-span"><?php echo e($finalScore['userScore'] ? $finalScore['userScore'] : "N/A"); ?></span>
                      </div>

                      <div class="text-black font-medium-2 fw-bold certificate-card-body">
                          Total Score : <span class="certificate-span"><?php echo e($finalScore['totalScore'] ? $finalScore['totalScore'] : "N/A"); ?></span>
                      </div>

                      <div class="text-black font-medium-2 fw-bold certificate-card-body">
                          Your Percentage : <span class="certificate-span"><?php echo e(Helper::roundScorePercentage($finalScore['userScore'], $finalScore['totalScore'] )); ?>%</span>

                      </div>

                      <div class="text-black font-medium-2 fw-bold certificate-card-body certificate-mg-bottom">
                          Your Recognition : <span class="certificate-span"><?php echo Helper::userMedal($finalScore['userScore'], $finalScore['totalScore'] ); ?></span>
                      </div>
                    </div>
                </div>
              </div>
                ...
                <script>
                    ...
                    doc.setFontSize(50);
                    doc.addImage("<?php echo e(asset('images/certificate.png')); ?>", "png",0,0,300,0);
                      // add custom font to file
                    doc.addFont("<?php echo e(asset('custom-font/ImperialScript-Regular.ttf')); ?>", "ImperialScript", "normal");
                    doc.setFont("ImperialScript","normal");
                    doc.text("<?php echo e(ucfirst(Auth::user()->first_name) .' '. ucfirst(Auth::user()->last_name)); ?>", pageWidth / 2, pageHeight  - 100,'center', {align: 'center'});
                    doc.setFontSize(18);
                    doc.setFont("times", "normal");
                    doc.text("<?php echo e($completionDate); ?>",85,160);
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/zeroguess.us/public_html/n17/FFN/app/resources/views/content/students/certificate/index.blade.php ENDPATH**/ ?>