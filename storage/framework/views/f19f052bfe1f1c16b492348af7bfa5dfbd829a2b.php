<?php $__env->startSection('title', 'Manage Scorecards'); ?>
...
<input class="hiddenput referral-code-copy form-control text-black fw-bold text-center font-medium-4" value="<?php echo e(Auth::user()->referral_code); ?>" onclick="copyText(this);"  readonly id="copyMaker"/>
        ...
        <div class="card manage-scorecard-container">
            ...
            <div class="card-header border-bottom-2 border-bottom-black d-inline scorecard-card-details-header">
                ...
                <div class=" float-lg-end font-medium-2 text-black fw-bold">
                    ...
                    Total Students : <?php echo e($students->count()); ?>
            ...
            <div class="card-body mt-1 scorecard-card-details-content">
                ...
                <div class="row" id="user_infomation_card">
                    <?php if($students->count()): ?>
                        <div class="">
                            <div class="float-start">
                                Showing <?php echo e(($studentRecord['paginate']->currentPage()-1)* $studentRecord['paginate']->perPage()+($studentRecord['paginate']->total() ? 1:0)); ?> to <?php echo e(($studentRecord['paginate']->currentPage()-1)*$studentRecord['paginate']->perPage()+count($studentRecord['paginate'])); ?>  of  <?php echo e($studentRecord['paginate']->total()); ?>  Results
                            </div>
                        <div class="float-end form-group col-md-4 d-flex">
                            <select name="file_format" id="file-format" class="form-select text-black fw-bold">
                                ...
                                <?php $__currentLoopData = config('setting.file_format'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" class="fw-bold text-black"><?php echo e($format); ?></option>
                    ...
                    <table class="table table-bordered text-black fw-bold mt-2">
                     ...
                     <?php $__currentLoopData = $studentRecord['record']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo e($item['completedModule']); ?>
                    ...
                    <div class="row pagination-container">
                            <?php echo e($studentRecord['paginate']->links()); ?>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        ...
        $('#submit_score_card_form').click((e) => {
            ...
            $.ajax({
                url : "<?php echo e(route('teacher.student_score')); ?>",
                type: "POST",
                data: formData,
                headers: {
        ...
        $('#download-records').click((e) => {
            ...
            if(type == ""){
                ...
                submitLoader(e.target)
                window.location.href ="<?php echo e(route('download-pdf')); ?>"
                submitReset(e.target);
            }else{
                $('#file-format').css("border","")
                ...
                $.ajax({
                    url : "<?php echo e(url('export_student_record')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/zeroguess.us/public_html/n17/FFN/app/resources/views/content/teachers/ScoreCard/index.blade.php ENDPATH**/ ?>