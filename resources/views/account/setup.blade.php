                ...
                <div class="card-body">
                    ...
                    @if(!auth()->user()->hasVerifiedEmail())
                        <div class="col-12 mt-75 text-center">
                                ...
                                <p>
                                    Just click on the link in that email to continue. If you don't see it, you may need to <strong>check your spam</strong> folder.
                                </p>
                                <p>
                    ...
                    @else
                        <form id="setup-form" class="mt-2" method="POST" action="{{ route('subscriber.setup') }}">
                            ...
                            <div class="form-group">
                                <label for="login-area_of_interest" class="form-label">Areas of Interest</label>
