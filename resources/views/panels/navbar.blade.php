...
<nav class="header-navbar d-lg-block d-md-block d-sm-none navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center {{ $configData['navbarColor'] }}"
    ...
    <nav
        class="header-navbar navbar d-lg-block d-md-block d-sm-none navbar-expand-lg align-items-center {{ $configData['navbarClass'] }} {{ $configData['navbarColor'] }} {{ ($configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType']  === 'navbar-floating') ? 'container-xxl' : '' }}">
        @endif
        <div class="navbar-container d-flex content">
            <ul class="nav navbar-nav align-items-center ms-auto dashboard-navbar-ul">
                @if(isset($menuData[0]->menu[0]['my-couse-navbar']))
                @if ($menuData[0]->menu[0]['my-couse-navbar'] === true &&  !isset($is_teacher))
              ...
              <a href="{{ url('/account')}}" class="">
                ...
                <li class="nav-item p-2">
                    <a href="{{ url('/my-certificate')}}" class="">
                ...
                <li class="nav-item p-2">
                    <a href=" {{config('setting.url.site-url')}}#home-custom-footer" class="" target="_blank">
                        <i class="fi fi-br-link"></i>
                        <span class="menu-title text-wrap text-dark ">FFN Information and Links</span>
                    </a>
                </li>
                    <li class="nav-item p-2">
                    <a href="{{ url('/donation')}}" class="">
                    ...
                    <div class="dropdown-menu dropdown-menu-end course-account-dropdown" aria-labelledby="dropdown-user">
                        <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                            ...
                            <div class="user-nav d-sm-flex d-none">
                                <span class="user-name text-black fw-bolder">{{ auth()->user()->fullName() }}</span>
                                <span
                                    class="user-status text-black fw-bolder">{{ auth()->user()->getRoleNames()[0] }}</span>
                            </div>
                            <span class="avatar">
                                <img class="round" src="{{ auth()->user()->profileImage() }}" alt="avatar" height="40"
                                    width="40">
                ...
                @elseif (isset($is_teacher))
                <li class="nav-item p-2">
                    <a href="{{ url('/teacher-home')}}" class="">
                        <i class="fi  fi-br-grid"></i>
            ...
            <a href="{{ url('/account')}}" class="">
                ...
                <li class="nav-item p-2">
                    <a href="{{ url('/manage-scorecards')}}" class="">
                        <i class="fi fi-br-diploma"></i>
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end course-account-dropdown" aria-labelledby="dropdown-user">
                        <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                            href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true">
                            <div class="user-nav d-sm-flex d-none">
                                <span class="text-black fw-bolder text-wrap fullname-span">{{ auth()->user()->fullName() }}</span>
                                <span
                                    class="user-status text-black fw-bolder">{{ auth()->user()->getRoleNames()[0] }}</span>
                            </div>
                            <span class="avatar">
