...
@if(!Auth::user()->referred_by && auth()->user()->hasRole('student'))
...
<div class="total-container">
  <div class="card donate">
     <form action="{{Route('processTransaction')}}" id="donation-form" method="post">
          @csrf 
          ...
          <div class="donate-flex-container">
            <div class="donate-black">
                <img src="{{asset('images/donation-image/ezgif.com-gif-maker.gif')}}" alt="">
            </div>
            ...
            <div class="donate-blue">
              ...
              <div class="donate-amount-box">
                <div class="donate-amount">
                  ...
                  {{-- <div class="denomination">
                    <input autocomplete="off" type="radio" name="amount" id="amount6" value="6">
                    <label for="amount6">$6</label>
                  </div> --}}
                </div>
                <div class="denomination-other">
                    <input autocomplete="off"  class="amount" type="number" name="donate_amount" value="{{old('donate_amount')}}" placeholder="Enter Other Amount*">
                  </div>
                  @error('donate_amount')
