...
<span data-toggle="tooltip" data-placement="top" title="open section" class="text-info font-m">
    <i data-feather='arrow-right-circle'></i><span>
                ...
                <div class=" card me-1 dashboard-module-card" style="background-image:url()">
                    ...
                    <div class="card-body module-exam-card text-black fw-bold d-grid">
                        ...
                        <div class="mark-body text-black fw-bold mt-1 font-s d-flex justify-content-around">
                            ...
                            <div>
                                Final Exam Question Attempted: {{ $getAllQuestionCountOfModule}}
                            </div>
                            <div>
                                Final Exam Questions Correct: {{$singleModuleFinalExamAnswer}}
                            </div>
                            @else
                            {{-- @php
                            $introQuizQuestion = $module->getAllQuestionCountOfModuleIntro();
                            $introQuizAnswer = $module->singleModuleFinalExamAnswerIntro();
                            @endphp --}}
                        ...
                        <div class="mark-body text-black fw-bold mt-1 font-s d-flex justify-content-around">
                            ...
                            <div>
                                Total Questions Answered in Module: {{ $allQuestionsAttemptsByStudent + $getAllQuestionCountOfModule  }}
                            </div>
                            <div>
                                Total Questions Correct in Module: {{$allCorrectQuestionsByStudent + $singleModuleFinalExamAnswer }}
                            </div>
                        ...
                        <div class="module-exam-score-container">
                            <div class="module-exam-score">
                                <div class="col-sm-3 col-md-2">
                                    ...
                                    <div class="conainer">
                                        <div class="circle_percent" data-percent="{{Helper::roundScorePercentage($allCorrectQuestionsByStudent + $singleModuleFinalExamAnswer ,$allQuestionsAttemptsByStudent + $getAllQuestionCountOfModule )}}">
     ...
     @endif --}}
            ...
            @if ((!empty($studentScore) && $studentScore['studentAttemptsQuestion'] > 0) || !empty($introQuizAnswer) )
                    ...
                    <div class="card-body module-exam-card text-black fw-bold d-grid">
                        ...
                        <div class="mark-body text-black fw-bold mt-1 font-s d-flex justify-content-around">
                            ...
                            <div class="mt-1">
                                ...
                                Total Questions Answered in Module : {{ $studentAttemptsQuestion  }}
                            </div>
                            <div>

                                Total Questions Correct in Module : {{ $studentCorrectAnswer  }}
                            </div>
                        </div>

                        <div class="mark-body text-black fw-bold mt-1 font-s d-flex justify-content-around">
                            <div class="mt-1">
                                {{ Helper::roundScorePercentage($studentCorrectAnswer  , $studentAttemptsQuestion )  }}% Correct
                            </div>
                            <div class="">
                                {!! Helper::userMedal($studentCorrectAnswer  , $studentAttemptsQuestion  )!!}
                            </div>
                        </div>
                        ...
                        <div class="mark-body text-black fw-bold mt-1 font-s d-flex justify-content-around">
                            ...
                            <div class="mt-1 medal-img">
                                ...
                                $img = '';
                                if($percentage< 70){ $img="images/bronze-medal.png" ; }else if($percentage < 85){ $img="images/silver-medal.png" ; }else{ $img="images/gold-medal.png" ; } @endphp <img src="{{asset($img)}}" />
                            </div>
                        ...
                        <div class="module-exam-score-container">
                            <div class="module-exam-score">
                                <div class="col-sm-3 col-md-2">
                                    ...
                                    <div class="conainer">
                                        <div class="circle_percent" data-percent="{{Helper::roundScorePercentage($studentCorrectAnswer , $studentAttemptsQuestion)}}">
                                            <div class="circle_inner">
                                                <div class="round_per"></div>
                                            </div>
                                        </div>
